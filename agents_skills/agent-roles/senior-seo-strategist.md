...
- Core Web Vitals pass rate: > 90% on key landing pages.
...
- Maintain metadata quality (titles, descriptions, headings, schema where relevant).
...
- Protect Core Web Vitals during design and feature changes.
...
4. Measure: evaluate KPI deltas and page-level outcomes.
...
- Content and technical work remain aligned with business goals.
